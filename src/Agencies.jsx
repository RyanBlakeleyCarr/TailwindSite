...
const CALENDLY_URL = "https://calendly.com/blakeley-digital/tailwind-learn-more";
function calendlyHref() {
  if (typeof window === "undefined" || !window.location.search || window.location.search.length <= 1) return CALENDLY_URL;
  return CALENDLY_URL + window.location.search;
}
  ...
  return (
    <section className="hero-section" style={{ backgroundColor: WHITE, color: NAVY, minHeight: "100vh", display: "flex", alignItems: "center" }}>
      <div className="hero-inner" style={{ maxWidth: 1120, margin: "0 auto", padding: "100px 24px 80px", textAlign: "center" }}>
        ...
        <FadeIn delay={0.05}><h1 style={{ fontFamily: "'Merriweather', Georgia, serif", fontSize: "clamp(36px, 4.2vw, 50px)", fontWeight: 400, lineHeight: 1.12, letterSpacing: "-0.025em", maxWidth: 1080, marginBottom: 28, color: NAVY, marginLeft: "auto", marginRight: "auto" }}>We <span style={{ fontWeight: 700 }}>build and grow</span> newsletters that convert<br className="hero-br" /> readers into <span style={{ fontWeight: 700, color: GREEN }}>agency clients</span>.</h1></FadeIn>
        <FadeIn delay={0.1}><p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "clamp(17px, 2vw, 20px)", lineHeight: 1.6, color: GRAY_TEXT, maxWidth: 960, marginBottom: 40, marginLeft: "auto", marginRight: "auto" }}><span style={{ fontWeight: 700 }}>Engage your audience</span> with world-class emails, <span style={{ fontWeight: 700 }}>convert them into booked sales calls</span>, and let<br className="sub-br" /> <span style={{ fontWeight: 700, fontStyle: "italic" }}>the most experienced team in the newsletter game</span> manage every step.</p></FadeIn>
        <FadeIn delay={0.15}>
        ...
        <FadeIn delay={0.2}><a href={calendlyHref()} target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", fontFamily: "'DM Sans', sans-serif", fontSize: 16, fontWeight: 600, color: WHITE, backgroundColor: NAVY, padding: "14px 32px", borderRadius: 6, textDecoration: "none", transition: "background-color 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = ACCENT_HOVER} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = NAVY}>Book a discovery call →</a></FadeIn>
        <FadeIn delay={0.35}><p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, lineHeight: 1.7, color: LIGHT_GRAY, marginTop: 32, marginLeft: "auto", marginRight: "auto" }}>30+ publications produced, 1.5M+ subscribers earned, 8-figures in client revenue generated.</p></FadeIn>
        <FadeIn delay={0.5}>
          ...
          <div style={{ maxWidth: 520 }}>
            <div ref={p1Ref} style={{ paddingTop: 24 }}>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 17, lineHeight: 1.8, color: GRAY_TEXT, marginBottom: 12, opacity: p1 ? 1 : 0, transform: p1 ? "translateY(0)" : "translateY(16px)", transition: ease() }}>
                Every channel you're already investing in (LinkedIn, YouTube, ads, your podcast) should point to one place:
              </p>
            ...
            <div ref={p3Ref}>
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 17, lineHeight: 1.8, color: GRAY_TEXT, marginBottom: 12, opacity: p3 ? 1 : 0, transform: p3 ? "translateY(0)" : "translateY(16px)", transition: ease(0.12) }}>
                A newsletter delivers content that converts in an engaging, value-first medium. Pair it with thoughtful segmentation and sales automation, and you have a machine that moves potential clients down your funnel in a natural, coherent, effective journey.
              </p>
            ...
            <div ref={p4Ref}>
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 17, lineHeight: 1.8, color: GRAY_TEXT, marginBottom: 32, opacity: p4 ? 1 : 0, transform: p4 ? "translateY(0)" : "translateY(16px)", transition: ease(0.24) }}>
                For an agency owner juggling client delivery, it's impossible to manage.
              </p>
            </div>
  ...
  return (
    <section className="mobile-section" style={{ backgroundColor: WHITE, color: NAVY, padding: "100px 24px", borderTop: `1px solid ${BORDER}` }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <FadeIn delay={0.6}><div style={{ marginTop: 56, textAlign: "center" }}><a href={calendlyHref()} target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", fontFamily: "'DM Sans', sans-serif", fontSize: 16, fontWeight: 600, color: WHITE, backgroundColor: NAVY, padding: "14px 32px", borderRadius: 6, textDecoration: "none", transition: "background-color 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = ACCENT_HOVER} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = NAVY}>Book a call →</a></div></FadeIn>
      </div>
    </section>
  );
}
...
function FitSection() {
  ...
  const fitItems = [
    <>You're selling retainers or high-ticket engagements with a proven track record of converting.</>,
    ...
    <>You're an agency owner or marketing lead who wants email managed by a team of experts (you're not looking for another channel to babysit)</>,
  ];
  const notFitItems = [
...
function AnnouncementBar() {
  return (
    <a href="/prompts" style={{ display: "block", backgroundColor: NAVY, color: "rgba(255,255,255,0.85)", textAlign: "center", padding: "11px 16px", fontFamily: "'DM Sans', sans-serif", fontSize: 14, lineHeight: 1.45, textDecoration: "none", transition: "background-color 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = ACCENT_HOVER} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = NAVY}>
      <span style={{ fontWeight: 700, color: WHITE }}>Get our free prompt pack:</span> 5 prompts for growing, engaging, and monetizing your email list <span style={{ fontWeight: 700, color: WHITE }}>→</span>
    </a>
  );
}
    ...
    <div style={{ margin: 0, padding: 0, backgroundColor: WHITE, overflowX: "hidden" }}>
      ...
      <style>{`
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        @media(max-width:900px){.sub-br{display:none}}
        @media(max-width:768px){
